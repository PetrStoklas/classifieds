...
const items = [
  {
    src: 'https://images.pexels.com/photos/305223/pexels-photo-305223.jpeg?auto=compress&c' +
      ...
      .map((image) => {
        ...
        return (
          <CarouselItem
            ...
            {/* <img
              className="w-100"
              src={"http://127.0.0.1:8000/uploads/products/" + image['filename']}
              alt={image['original_filename']}/> */}
            <img
              className="w-100"
              src={'http://127.0.0.1:8000/uploads/products/phpnehRZy.png'}
              alt={image['original_filename']}/>
          </CarouselItem>
        );
      });
    ...
    return (
      <Carousel activeIndex={activeIndex} next={this.next} previous={this.previous}>
        <CarouselIndicators
          ...
          onClickHandler={this.goToIndex}/> {slides}
        <CarouselControl
          direction="prev"
