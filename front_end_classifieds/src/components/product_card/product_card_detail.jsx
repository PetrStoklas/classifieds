          ...
          <Row className="card_info_section">
            <Container className="car_info rounded mt-2 mx-2 px-1">
              ...
              <div className="custom_desc">
                <p>Custom added AC, sport brakes Brembo, Recaro seats. The car was never crashed. I am the third owner. Can provide you with all documentation and paperworks of this car.
                </p>
              </div>
